  ...
  return (
    <div className="skill section bg-primary py-20" id="skills">
      <div className="text-center max-w-3xl mx-auto px-4">
        ...
        <p className="text-base sm:text-lg md:text-lg leading-relaxed">I am committed to designing intuitive and engaging UI/UX experiences, with a focus on ease of use and user satisfaction.</p>
      </div>
